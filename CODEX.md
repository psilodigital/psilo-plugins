...
This repo (`psilo-plugins`) is Psilodigital's plugin marketplace shipping three plugins: **sales**, **proposals**, **delivery**. See [AGENTS.md](AGENTS.md) for the install flow and structure.
